...
pub fn declare(smt: &Context, name: String, val: SExpr) -> SExpr {
...
pub fn cls64(smt: &Context, x: SExpr, id: u32) -> SExpr {
    ...
    smt.assert(smt.eq(zy32, smt.bvlshr(x, smt.atom("#x0000000000000020"))));
    ...
    smt.assert(smt.eq(zy16, smt.bvlshr(zx32, smt.atom("#x0000000000000010"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy8, smt.bvlshr(zx16, smt.atom("#x0000000000000008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy4, smt.bvlshr(zx8, smt.atom("#x0000000000000004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy2, smt.bvlshr(zx4, smt.atom("#x0000000000000002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy1, smt.bvlshr(zx2, smt.atom("#x0000000000000001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy32, smt.bvashr(x, smt.atom("#x0000000000000020"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy16, smt.bvashr(sx32, smt.atom("#x0000000000000010"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy8, smt.bvashr(sx16, smt.atom("#x0000000000000008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy4, smt.bvashr(sx8, smt.atom("#x0000000000000004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy2, smt.bvashr(sx4, smt.atom("#x0000000000000002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy1, smt.bvashr(sx2, smt.atom("#x0000000000000001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
...
pub fn cls32(smt: &Context, x: SExpr, id: u32) -> SExpr {
    ...
    smt.assert(smt.eq(zy16, smt.bvlshr(x, smt.atom("#x00000010"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy8, smt.bvlshr(zx16, smt.atom("#x00000008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy4, smt.bvlshr(zx8, smt.atom("#x00000004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy2, smt.bvlshr(zx4, smt.atom("#x00000002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy1, smt.bvlshr(zx2, smt.atom("#x00000001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy16, smt.bvashr(x, smt.atom("#x00000010"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy8, smt.bvashr(sx16, smt.atom("#x00000008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy4, smt.bvashr(sx8, smt.atom("#x00000004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy2, smt.bvashr(sx4, smt.atom("#x00000002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy1, smt.bvashr(sx2, smt.atom("#x00000001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
...
pub fn cls16(smt: &Context, x: SExpr, id: u32) -> SExpr {
    ...
    smt.assert(smt.eq(zy8, smt.bvlshr(x, smt.atom("#x0008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy4, smt.bvlshr(zx8, smt.atom("#x0004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy2, smt.bvlshr(zx4, smt.atom("#x0002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy1, smt.bvlshr(zx2, smt.atom("#x0001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy8, smt.bvashr(x, smt.atom("#x0008"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy4, smt.bvashr(sx8, smt.atom("#x0004"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy2, smt.bvashr(sx4, smt.atom("#x0002"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy1, smt.bvashr(sx2, smt.atom("#x0001"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
...
pub fn cls8(smt: &Context, x: SExpr, id: u32) -> SExpr {
    ...
    smt.assert(smt.eq(zy4, smt.bvlshr(x, smt.atom("#x04"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy2, smt.bvlshr(zx4, smt.atom("#x02"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(zy1, smt.bvlshr(zx2, smt.atom("#x01"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy4, smt.bvashr(x, smt.atom("#x04"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy2, smt.bvashr(sx4, smt.atom("#x02"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
    ...
    smt.assert(smt.eq(sy1, smt.bvashr(sx2, smt.atom("#x01"))));
    smt.assert(smt.list(vec![
        smt.atom("ite"),
        smt.list(vec![
            smt.atom("not"),
...
pub fn cls1(smt: &Context, id: u32) -> SExpr {
    // Generated code.
    let cls1ret = declare(
        smt,
