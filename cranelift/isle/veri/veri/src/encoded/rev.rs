...
pub fn rev16(smt: &mut Context, x: SExpr, id: usize) -> SExpr {
    ...
    let _ = smt.assert(smt.eq(
        ...
        smt.bvor(
            smt.bvlshr(
                smt.bvand(x1, smt.atom("#xf0f0")),
                smt.atom("#x0004"),
            ),
            smt.bvshl(
                smt.bvand(x1, smt.atom("#x0f0f")),
                smt.atom("#x0004"),
            ),
        ),
    ));
    ...
    let _ = smt.assert(smt.eq(
        ...
        smt.bvor(
            smt.bvlshr(
                smt.bvand(x2, smt.atom("#xcccc")),
                smt.atom("#x0002"),
            ),
            smt.bvshl(
                smt.bvand(x2, smt.atom("#x3333")),
                smt.atom("#x0002"),
            ),
        ),
    ));
    let rev16ret = declare(smt,
    ...
    let _ = smt.assert(smt.eq(
        ...
        smt.bvor(
            smt.bvlshr(
                smt.bvand(x3, smt.atom("#xaaaa")),
                smt.atom("#x0001"),
            ),
            smt.bvshl(
                smt.bvand(x3, smt.atom("#x5555")),
                smt.atom("#x0001"),
            ),
        ),
    ));
...
pub fn rev8(smt: &mut Context, x: SExpr, id: usize) -> SExpr {
    ...
    let _ = smt.assert(smt.eq(
        ...
        smt.bvor(
            smt.bvlshr(
                smt.bvand(x1, smt.atom("#xcc")),
                smt.atom("#x02"),
            ),
            smt.bvshl(
                smt.bvand(x1, smt.atom("#x33")),
                smt.atom("#x02"),
            ),
        ),
    ));
    let rev8ret = declare(smt,
    ...
    let _ = smt.assert(smt.eq(
        ...
        smt.bvor(
            smt.bvlshr(
                smt.bvand(x2, smt.atom("#xaa")),
                smt.atom("#x01"),
            ),
            smt.bvshl(
                smt.bvand(x2, smt.atom("#x55")),
                smt.atom("#x01"),
            ),
        ),
    ));
